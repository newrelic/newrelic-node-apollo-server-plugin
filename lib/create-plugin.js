...
function recordResolveSegment(segment, scope) {
  ...
  if (fieldName) {
    ...
    createMetrics(transaction, fieldNameMetric, scope, duration, exclusive)
  }
}
...
function recordOperationSegment(segment, scope) {
  ...
  createMetrics(transaction, segment.name, scope, duration, exclusive)
}

function createMetrics(transaction, name, scope, duration, exclusive) {
  if (scope) {
